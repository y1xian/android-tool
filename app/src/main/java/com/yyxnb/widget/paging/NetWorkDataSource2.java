...
public class NetWorkDataSource2 extends ItemKeyedDataSource<Integer,TestData> {
...
//    }
    ...
    @Override
    public void loadInitial(@NonNull LoadInitialParams<Integer> params, @NonNull LoadInitialCallback<TestData> callback) {
        callback.onResult(fetchItems(0));
    }

    @Override
    public void loadAfter(@NonNull LoadParams<Integer> params, @NonNull LoadCallback<TestData> callback) {
        if (params.key > 0){
    ...
    @Override
    public void loadBefore(@NonNull LoadParams<Integer> params, @NonNull LoadCallback<TestData> callback) {
        callback.onResult(Collections.emptyList());
    }

    @NonNull
    @Override
    public Integer getKey(@NonNull TestData item) {
