...
public final class Permission {
     ...
     */
    public static Permission create(Context context, @PermissionConstants.Permission final String... permissions) {
        if(sInstance == null) return new Permission(context, permissions);
    ...
    private Permission(Context ctx, final String... permissions) {
        sInstance = this;
        context = ctx;
        prepare(permissions);
    }
