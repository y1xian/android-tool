package com.yyxnb.oh.popup.widget;
...
import com.yyxnb.oh.popup.enums.LayoutStatus;
...
//        boolean canChildScrollRight = canScroll(this, ev.getX(), ev.getY(), -1);
    ...
    protected void dispatchDraw(Canvas canvas) {
        ...
        if (isDrawStatusBarShadow) {
            ...
            paint.setColor((Integer) argbEvaluator.evaluate(fraction, defaultColor, PopupManager.statusBarShadowColor));
