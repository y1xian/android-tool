...
import com.yyxnb.oh.popup.R;
import com.yyxnb.oh.popup.enums.PopupStatus;
import com.yyxnb.oh.popup.interfaces.OnDragChangeListener;
import com.yyxnb.oh.popup.interfaces.OnSrcViewUpdateListener;
import com.yyxnb.oh.popup.interfaces.PopupImageLoader;
import com.yyxnb.oh.popup.photoview.OnMatrixChangedListener;
import com.yyxnb.oh.popup.photoview.PhotoView;
import com.yyxnb.oh.popup.util.Permission;
import com.yyxnb.oh.popup.util.PermissionConstants;
import com.yyxnb.oh.popup.util.PopupUtils;
import com.yyxnb.oh.popup.widget.BlankView;
import com.yyxnb.oh.popup.widget.HackyViewPager;
import com.yyxnb.oh.popup.widget.PhotoViewContainer;
...
public class ImageViewerPopupView extends BasePopupView implements OnDragChangeListener, View.OnClickListener {
    ...
    protected PopupImageLoader imageLoader;
    ...
    public ImageViewerPopupView(@NonNull Context context) {
        ...
        if (initLayoutResId() > 0) {
            customView = LayoutInflater.from(getContext()).inflate(initLayoutResId(), container, false);
    ...
    protected int getPopupLayoutId() {
        return R.layout._popup_image_viewer_popup_view;
    }
...
//        pager.setOffscreenPageLimit(urls.size());
    ...
    private void setupPlaceholder() {
        ...
        if (isShowPlaceholder) {
            ...
            PopupUtils.setWidthHeight(placeholderView, rect.width(), rect.height());
    ...
    private void addOrUpdateSnapshot() {
        ...
        if (snapshotView == null) {
            ...
            PopupUtils.setWidthHeight(snapshotView, rect.width(), rect.height());
        }
        setupPlaceholder();
    ...
    public void doShowAnimation() {
        ...
        snapshotView.post(new Runnable() {
            ...
            public void run() {
                ...
                PopupUtils.setWidthHeight(snapshotView, photoViewContainer.getWidth(), photoViewContainer.getHeight());
    ...
    private int getDuration(){
        return PopupManager.getAnimationDuration() + 60;
    } 
    ...
    public ImageViewerPopupView setXPopupImageLoader(PopupImageLoader imageLoader) {
    ...
    protected void save() {
        //check permission
        Permission.create(getContext(), PermissionConstants.STORAGE)
                .callback(new Permission.SimpleCallback() {
                    @Override
                    public void onGranted() {
                        //save bitmap to album.
                        PopupUtils.saveBmpToAlbum(getContext(), imageLoader, urls.get(isInfinite ? position % urls.size() : position));
                    }
