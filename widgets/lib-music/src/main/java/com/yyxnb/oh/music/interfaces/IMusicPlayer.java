package com.yyxnb.oh.music.interfaces;
...
public interface IMusicPlayer {
     ...
     */
    <T extends IMusic> void setMusic(List<T> musicList, int index);
     ...
     * @param index     指定要播放的位置 0-data.size()
     */
    <T extends IMusic> void startPlayMusic(List<T> musicList, int index);
     ...
     */
    <T extends IMusic> void addPlayMusicToTop(T audioInfo);
     ...
     * @param index  位置
     */
    <T extends IMusic> void updateMusicPlayerData(List<T> audios, int index);
     ...
     * @return 音频对象
     */
    <T extends IMusic> T getCurrentPlayerMusic();
...
//    String getCurrentPlayerHashKey();
     ...
     * @return 播放器持有的播放数据集
     */
    <T extends IMusic> List<T> getCurrentPlayList();
