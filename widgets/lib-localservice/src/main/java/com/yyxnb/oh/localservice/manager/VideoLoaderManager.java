...
import com.yyxnb.oh.localservice.LocalConfig;
import com.yyxnb.oh.localservice.R;
import com.yyxnb.oh.localservice.bean.LocalFolder;
import com.yyxnb.oh.localservice.bean.LocalMedia;
 ...
 * 视频
 */
public class VideoLoaderManager extends LoaderM implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    public VideoLoaderManager(Context context, DataCallback loader) {
    ...
    public void onLoadFinished(Loader loader, Cursor cursor) {
        try {
            ...
            while (cursor.moveToNext()) {
                ...
                Log.d("VideoLoaderManager", name + " ， " + mediaType + " ， "+ mimeType);
