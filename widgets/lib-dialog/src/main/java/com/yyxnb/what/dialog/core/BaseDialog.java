 ...
 * Dialog 基类
 */
public class BaseDialog extends AppCompatDialog implements LifecycleOwner, AnimAction,
    ...
    public void dismiss() {
        ...
        if (focusView != null) {
            getContext().getSystemService(InputMethodManager.class).hideSoftInputFromWindow(focusView.getWindowToken(), 0);
        }
        super.dismiss();
    }
    ...
    public static class Builder<B extends Builder> implements LifecycleOwner {
