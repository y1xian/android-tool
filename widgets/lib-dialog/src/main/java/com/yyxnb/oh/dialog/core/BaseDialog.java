package com.yyxnb.oh.dialog.core;
...
import com.yyxnb.oh.anim.action.AnimAction;
import com.yyxnb.oh.core.UITask;
import com.yyxnb.oh.core.action.ClickAction;
import com.yyxnb.oh.core.action.CoreAction;
import com.yyxnb.oh.core.action.ResourcesAction;
import com.yyxnb.oh.dialog.R;
...
public class BaseDialog extends AppCompatDialog implements LifecycleOwner,
        CoreAction, ResourcesAction, ClickAction, AnimAction,
    ...
    public static class Builder<B extends Builder> implements LifecycleOwner, CoreAction, ResourcesAction, ClickAction {
        ...
        public final void postDelayed(Runnable r, long delayMillis) {
            if (isShowing()) {
                UITask.postDelayed(r, delayMillis);
            } else {
        ...
        public final void postAtTime(Runnable r, long uptimeMillis) {
            if (isShowing()) {
                UITask.postDelayed(r, uptimeMillis);
            } else {
...
//            }
    ...
    private static final class ListenersWrapper<T extends DialogInterface.OnShowListener & DialogInterface.OnCancelListener & DialogInterface.OnDismissListener>
            extends SoftReference<T> implements LifecycleObserver, DialogInterface.OnShowListener, DialogInterface.OnCancelListener, DialogInterface.OnDismissListener {
    ...
    private static final class ShowListenerWrapper
            ...
            implements LifecycleObserver, BaseDialog.OnShowListener {
    ...
    private static final class CancelListenerWrapper
            ...
            implements LifecycleObserver, BaseDialog.OnCancelListener {
    ...
    private static final class DismissListenerWrapper
            ...
            implements LifecycleObserver, BaseDialog.OnDismissListener {
    ...
    private static final class KeyListenerWrapper
            implements LifecycleObserver, DialogInterface.OnKeyListener {
     ...
     * post 任务包装类
     */
    private static final class ShowPostWrapper implements LifecycleObserver, OnShowListener {
     ...
     * postDelayed 任务包装类
     */
    private static final class ShowPostDelayedWrapper implements LifecycleObserver, OnShowListener {
        ...
        public void onShow(BaseDialog dialog) {
            if (mRunnable != null) {
                dialog.removeOnShowListener(this);
                UITask.postDelayed(mRunnable, mDelayMillis);
            }
        }
    }
     ...
     * postAtTime 任务包装类
     */
    private static final class ShowPostAtTimeWrapper implements LifecycleObserver, OnShowListener {
        ...
        public void onShow(BaseDialog dialog) {
            if (mRunnable != null) {
                dialog.removeOnShowListener(this);
                UITask.postDelayed(mRunnable, mUptimeMillis);
            }
        }
    }
