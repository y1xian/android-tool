...
public class WebActivity extends AppCompatActivity {
    ...
    protected void initAgent(String url, ViewGroup v) {

        mAgentWeb = AgentWeb.with(this)//
                .setAgentWebParent(v, -1, new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.MATCH_PARENT))//传入AgentWeb的父控件。
