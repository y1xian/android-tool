...
public class StatusView extends FrameLayout {
    ...
    // 状态布局文件 Id 声明
    private @LayoutRes
    int loadingLayoutId = R.layout._sv_loading_layout;
    private @LayoutRes
    int emptyLayoutId = R.layout._sv_empty_layout;
    private @LayoutRes
    int errorLayoutId = R.layout._sv_error_layout;
    ...
    private void updateStatusView(@LayoutRes int layoutId, ViewHolder viewHolder) {
        ...
        if (layoutId == R.layout._sv_loading_layout) {
        ...
        } else if (layoutId == R.layout._sv_empty_layout) {
        ...
        } else if (layoutId == R.layout._sv_error_layout) {
