...
public class TitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        PADDING_10 = DpUtils.dp2px(10);
        PADDING_12 = DpUtils.dp2px(12);
        ...
        titleBarHeight = (int) array.getDimension(R.styleable.TitleBar_tb_titleBarHeight, DpUtils.dp2px(48));
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftTextSize = array.getDimension(R.styleable.TitleBar_tb_leftTextSize, DpUtils.dp2px(16));
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            rightTextSize = array.getDimension(R.styleable.TitleBar_tb_rightTextSize, DpUtils.dp2px(16));
        ...
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerTextSize = array.getDimension(R.styleable.TitleBar_tb_centerTextSize, DpUtils.dp2px(20));
            ...
            centerSubTextSize = array.getDimension(R.styleable.TitleBar_tb_centerSubTextSize, DpUtils.dp2px(12));
    ...
    private void initGlobalViews(Context context) {
        ...
        // 计算主布局高度
        if (showBottomLine) {
            mainParams.height = titleBarHeight - Math.max(1, DpUtils.dp2px(0.1f));
        } else {
        ...
        if (showBottomLine) {
            ...
            LayoutParams bottomLineParams = new LayoutParams(MATCH_PARENT, Math.max(1, DpUtils.dp2px(0.1f)));
...
//            tvCenter.setMaxWidth((int) (BarUtils.getScreenPixelSize(context)[0] * 3 / 5.0));
            ...
            int progressWidth = DpUtils.dp2px(18);
