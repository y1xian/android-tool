...
/**
 * 提示音，震动帮助类
 * 需要权限 {@code <uses-permission android:name="android.permission.VIBRATE" />}
 *
 * @author yyx
 */
public class VibrateUtil {
	 ...
	 */
	public static void playBeep(Activity context, boolean vibrate, int rawResId) {
		...
		if (vibrate) {
			vibrateOnce(context, VIBRATE_DURATION);
		}
	}
