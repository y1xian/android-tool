...
public class HandlerUtil {
	 ...
	 */
	public HandlerUtil(@Nullable Handler.Callback callback) {
	 ...
	 */
	public HandlerUtil(@NonNull Looper looper) {
		mCallback = null;
	 ...
	 * @param callback The callback interface in which to handle messages, or null.
	 */
	public HandlerUtil(@NonNull Looper looper, @NonNull Handler.Callback callback) {
		mCallback = callback;
