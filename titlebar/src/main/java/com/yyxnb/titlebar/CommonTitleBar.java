...
public class CommonTitleBar extends RelativeLayout implements View.OnClickListener {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        PADDING_12 = BarUtils.dp2PxInt(context, 12);
        ...
        titleBarColor = array.getColor(R.styleable.CommonTitleBar_titleBarColor, getResources().getColor(R.color.titleBar));
        titleBarHeight = (int) array.getDimension(R.styleable.CommonTitleBar_titleBarHeight, BarUtils.dp2PxInt(context, 48));

        showBottomLine = array.getBoolean(R.styleable.CommonTitleBar_showBottomLine, true);
        bottomLineColor = array.getColor(R.styleable.CommonTitleBar_bottomLineColor, getResources().getColor(R.color.item_div_bg));
        ...
        if (leftType == TYPE_LEFT_TEXTVIEW) {
            ...
            leftTextColor = array.getColor(R.styleable.CommonTitleBar_leftTextColor, getResources().getColor(R.color.title_color));
            leftTextSize = array.getDimension(R.styleable.CommonTitleBar_leftTextSize, BarUtils.dp2PxInt(context, 16));
            ...
            leftImageResource = array.getResourceId(R.styleable.CommonTitleBar_leftImageResource, R.mipmap.icon_titlebar_back);
        ...
        if (rightType == TYPE_RIGHT_TEXTVIEW) {
            ...
            rightTextColor = array.getColor(R.styleable.CommonTitleBar_rightTextColor, getResources().getColor(R.color.title_color));
            rightTextSize = array.getDimension(R.styleable.CommonTitleBar_rightTextSize, BarUtils.dp2PxInt(context, 16));
        ...
        if (centerType == TYPE_CENTER_TEXTVIEW) {
            ...
            centerTextColor = array.getColor(R.styleable.CommonTitleBar_centerTextColor, getResources().getColor(R.color.title_color));
            centerTextSize = array.getDimension(R.styleable.CommonTitleBar_centerTextSize, BarUtils.dp2PxInt(context, 20));
            ...
            centerSubTextColor = array.getColor(R.styleable.CommonTitleBar_centerSubTextColor, getResources().getColor(R.color.auxiliary_color));
            centerSubTextSize = array.getDimension(R.styleable.CommonTitleBar_centerSubTextSize, BarUtils.dp2PxInt(context, 12));
    ...
    private void initGlobalViews(Context context) {
        ...
        // 计算主布局高度
        if (showBottomLine) {
            mainParams.height = titleBarHeight - Math.max(1, BarUtils.dp2PxInt(context, 0.1f));
        } else {
        ...
        if (showBottomLine) {
            ...
            LayoutParams bottomLineParams = new LayoutParams(MATCH_PARENT, Math.max(1, BarUtils.dp2PxInt(context, 0.1f)));
