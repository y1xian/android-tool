...
public class StrUtil {
	...
	private static boolean isNullOrUndefinedStr(CharSequence str) {
		...
		return StringConstants.NULL.equals(strString) || StringConstants.UNDEFINED.equals(strString);
	}
	...
	public static String subBefore(CharSequence string, char separator, boolean isLastSeparator) {
		if (isEmpty(string)) {
			return null == string ? null : StringConstants.EMPTY;
		}
	...
	public static String getContainsStr(CharSequence str, CharSequence... testStrs) {
		if (isEmpty(str) || UtilInner.isEmpty(testStrs)) {
			return null;
		}
	...
	public static String format(CharSequence template, Object... params) {
		...
		if (UtilInner.isEmpty(params) || isBlank(template)) {
			return template.toString();
		}
		return String.format(Locale.ENGLISH, template.toString(), params);
	}
	...
	public static String removeAll(CharSequence str, CharSequence strToRemove) {
		...
		return str.toString().replace(strToRemove, StringConstants.EMPTY);
	}
	...
	public static String removeAll(CharSequence str, char... chars) {
		if (null == str || UtilInner.isEmpty(chars)) {
			return str(str);
		}
		final int len = str.length();
		if (0 == len) {
	...
	public static boolean startWithAny(CharSequence str, CharSequence... prefixes) {
		if (isEmpty(str) || UtilInner.isEmpty(prefixes)) {
			return false;
		}
	...
	public static boolean endWithAny(CharSequence str, CharSequence... suffixes) {
		if (isEmpty(str) || UtilInner.isEmpty(suffixes)) {
			return false;
		}
	...
	public static byte[] utf8Bytes(CharSequence str) {
		return bytes(str, StringConstants.CHARSET_UTF_8);
	}
