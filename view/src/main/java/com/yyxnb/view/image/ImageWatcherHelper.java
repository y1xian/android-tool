...
/*
    ImageWatcherHelper.with(this, new GlideSimpleLoader()) // 一般来讲， ImageWatcher 需要占据全屏的位置
                ...
                .show((ImageView) v, mappingViews, convert(longPictureList));
 */
...
//    }
    ...
    public void showString(List<String> urlList, int initPos) {
        init();
        mImageWatcher.show(convert(urlList), initPos);
        appendOtherView();
    }
