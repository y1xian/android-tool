...
import com.yyxnb.view.popup.PopupDrawerLayout;
 ...
 */
public abstract class DrawerPopup extends BasePopup {

    PopupDrawerLayout drawerLayout;
    protected FrameLayout drawerContentContainer;

    public DrawerPopup(@NonNull Context context) {
        super(context);
    ...
    protected void initPopupContent() {
        ...
        drawerLayout.setOnCloseListener(new PopupDrawerLayout.OnCloseListener() {
            @Override
            public void onClose() {
                DrawerPopup.super.dismiss();
            }

            @Override
            public void onOpen() {
                DrawerPopup.super.doAfterShow();
            }
