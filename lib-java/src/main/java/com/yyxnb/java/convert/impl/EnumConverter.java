...
public class EnumConverter extends AbstractConverter<Object> {
	...
	protected Object convertInternal(Object value) {
		...
		throw new ConvertException("Can not convert %s to %s", value, this.enumClass);
	}
