...
import com.yyxnb.java.SerializeUtil;
import com.yyxnb.java.StrUtil;
import com.yyxnb.java.collection.ArrayUtil;
import com.yyxnb.java.collection.IterUtil;
...
public class ArrayConverter extends AbstractConverter<Object> {
	...
	private Object convertObjectToArray(Object value) {
		if (value instanceof CharSequence) {
			...
			// 单纯字符串情况下按照逗号分隔后劈开
			final String[] strings = StrUtil.splitToArray(value.toString(), StrUtil.COMMA);
	...
	private Object convertComponentType(Object value) {
		return ConvertUtil.convertWithCheck(this.targetComponentType, value, null, this.ignoreElementError);
	}
	// -------------------------------------------------------------------------------------- Private method end
}
