...
public final class KeyboardUtils {
     ...
     */
    public static void registerSoftInputChangedListener(final Activity activity, final ViewGroup viewGroup, final OnSoftInputChangedListener listener) {
        ...
        listenerMap.put(viewGroup, listener);
    ...
    public static void removeLayoutChangeListener(View decorView, ViewGroup viewGroup) {
