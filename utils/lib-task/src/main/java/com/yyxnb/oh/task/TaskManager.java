...
import com.yyxnb.oh.task.sort.TaskSortUtil;
import com.yyxnb.oh.task.task.ITask;
import com.yyxnb.oh.task.task.Task;
import com.yyxnb.oh.task.task.TaskRunnable;
...
public class TaskManager {
    ...
    /**
     * 其作用是让主线程等待，优先执行那些必须要先执行完毕才能让主线程继续执行完毕，再跳转页面的task
     */
    @UiThread
