...
//                }
    ...
    public ItemDecoration setPaddingTop(int paddingTop) {
        this.paddingTop = DpUtils.dp2px( paddingTop);
        return this;
    }

    public ItemDecoration setPaddingBottom(int paddingBottom) {
        this.paddingBottom = DpUtils.dp2px( paddingBottom);
        return this;
    }

    public ItemDecoration setPaddingLeft(int paddingLeft) {
        this.paddingLeft = DpUtils.dp2px( paddingLeft);
        return this;
    }

    public ItemDecoration setPaddingRight(int paddingRight) {
        this.paddingRight = DpUtils.dp2px( paddingRight);
        return this;
    }
    ...
    public ItemDecoration setDividerHeight(int dividerHeight) {
        this.dividerHeight = DpUtils.dp2px( dividerHeight);
        return this;
    }
    ...
    public ItemDecoration setDividerWidth(int dividerWidth) {
        this.dividerWidth = DpUtils.dp2px( dividerWidth);
        return this;
    }
